package com.Ichif1205.gridreflexes.numbers;
...
public class NumbersActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (nextTargetNum == MAX_TARGET - 1) {
            // 終了
            // Stop Hanlder
            myHandler.removeCallbacks(updateTimerMethod);

            ResultActivity.startActivity(NumbersActivity.this, Construct.NUMBERS_MODE, mTimer);
            finish();
            return;
        }
